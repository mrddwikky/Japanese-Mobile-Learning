//
//  ProfesiBenarViewController.swift
//  Japanesia
//
...
class ProfesiBenarViewController: UIViewController {
...
class ProfesiBenarSatuViewController: ProfesiBenarViewController {
    ...
    @IBAction func lanjut1Button(_ sender: UIButton) {
        ...
        let lanjut1ViewController = UIStoryboard(name: "Profesi", bundle: nil).instantiateViewController(identifier: "ProfesiKedua") as! ProfesiKedua
...
class ProfesiBenarDuaViewController: ProfesiBenarViewController {
    ...
    @IBAction func lanjut2Button(_ sender: UIButton) {
        ...
        let lanjut2ViewController = UIStoryboard(name: "Profesi", bundle: nil).instantiateViewController(identifier: "ProfesiKetiga") as! ProfesiKetiga
...
class ProfesiBenarTigaViewController: ProfesiBenarViewController {
    ...
    @IBAction func lanjut3Button(_ sender: UIButton) {
        ...
        let lanjut3ViewController = UIStoryboard(name: "Profesi", bundle: nil).instantiateViewController(identifier: "ProfesiKeempat") as! ProfesiKeempat
...
class ProfesiBenarEmpatViewController: ProfesiBenarViewController {
    ...
    @IBAction func lanjut4Button(_ sender: UIButton) {
        ...
        let lanjut4ViewController = UIStoryboard(name: "Profesi", bundle: nil).instantiateViewController(identifier: "ProfesiKelima") as! ProfesiKelima
...
class ProfesiBenarLimaViewController: ProfesiBenarViewController {
    ...
    @IBAction func lanjut5Button(_ sender: UIButton) {
        ...
        let lanjut5ViewController = UIStoryboard(name: "Profesi", bundle: nil).instantiateViewController(identifier: "ProfesiKeenam") as! ProfesiKeenam
...
class ProfesiBenarEnamViewController: ProfesiBenarViewController {
    ...
    @IBAction func lanjut6Button(_ sender: UIButton) {
        ...
        let lanjut6ViewController = UIStoryboard(name: "Profesi", bundle: nil).instantiateViewController(identifier: "ProfesiKetujuh") as! ProfesiKetujuh
...
class ProfesiBenarTujuhViewController: ProfesiBenarViewController {
    ...
    @IBAction func lanjut7Button(_ sender: UIButton) {
        ...
        let lanjut7ViewController = UIStoryboard(name: "Profesi", bundle: nil).instantiateViewController(identifier: "ProfesiKedelapan") as! ProfesiKedelapan
...
class ProfesiBenarDelapanViewController: ProfesiBenarViewController {
    ...
    @IBAction func lanjut8Button(_ sender: UIButton) {
        ...
        let lanjut8ViewController = UIStoryboard(name: "Profesi", bundle: nil).instantiateViewController(identifier: "ProfesiKesembilan") as! ProfesiKesembilan
...
class ProfesiBenarSembilanViewController: ProfesiBenarViewController {
    ...
    @IBAction func lanju9Button(_ sender: UIButton) {
        ...
        let lanjut9ViewController = UIStoryboard(name: "Profesi", bundle: nil).instantiateViewController(identifier: "ProfesiKesepuluh") as! ProfesiKesepuluh
...
class ProfesiBenarSepuluhViewController: ProfesiBenarViewController {
    ...
    @IBAction func lanjut10Button(_ sender: UIButton) {
        ...
        let lanjut10ViewController = UIStoryboard(name: "Profesi", bundle: nil).instantiateViewController(identifier: "ProfesiCoinViewController") as! ProfesiCoinViewController
