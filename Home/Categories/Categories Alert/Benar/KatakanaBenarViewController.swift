//
//  KatakanaBenarViewController.swift
//  Japanesia
//
...
class KatakanaBenarViewController: UIViewController {
...
class KatakanaBenarSatuViewController: KatakanaBenarViewController {
    ...
    @IBAction func lanjut1Button(_ sender: UIButton) {
        ...
        let lanjut1ViewController = UIStoryboard(name: "Katakana", bundle: nil).instantiateViewController(identifier: "KatakanaKedua") as! KatakanaKedua
...
class KatakanaBenarDuaViewController: KatakanaBenarViewController {
    ...
    @IBAction func lanjut2Button(_ sender: UIButton) {
        ...
        let lanjut2ViewController = UIStoryboard(name: "Katakana", bundle: nil).instantiateViewController(identifier: "KatakanaKetiga") as! KatakanaKetiga
...
class KatakanaBenarTigaViewController: KatakanaBenarViewController {
    ...
    @IBAction func lanjut3Button(_ sender: UIButton) {
        ...
        let lanjut3ViewController = UIStoryboard(name: "Katakana", bundle: nil).instantiateViewController(identifier: "KatakanaKeempat") as! KatakanaKeempat
...
class KatakanaBenarEmpatViewController: KatakanaBenarViewController {
    ...
    @IBAction func lanjut4Button(_ sender: UIButton) {
        ...
        let lanjut4ViewController = UIStoryboard(name: "Katakana", bundle: nil).instantiateViewController(identifier: "KatakanaKelima") as! KatakanaKelima
...
class KatakanaBenarLimaViewController: KatakanaBenarViewController {
    ...
    @IBAction func lanjut5Button(_ sender: UIButton) {
        ...
        let lanjut5ViewController = UIStoryboard(name: "Katakana", bundle: nil).instantiateViewController(identifier: "KatakanaKeenam") as! KatakanaKeenam
...
class KatakanaBenarEnamViewController: KatakanaBenarViewController {
    ...
    @IBAction func lanjut6Button(_ sender: UIButton) {
        ...
        let lanjut6ViewController = UIStoryboard(name: "Katakana", bundle: nil).instantiateViewController(identifier: "KatakanaKetujuh") as! KatakanaKetujuh
...
class KatakanaBenarTujuhViewController: KatakanaBenarViewController {
    ...
    @IBAction func lanjut7Button(_ sender: UIButton) {
        ...
        let lanjut7ViewController = UIStoryboard(name: "Katakana", bundle: nil).instantiateViewController(identifier: "KatakanaKedelapan") as! KatakanaKedelapan
...
class KatakanaBenarDelapanViewController: KatakanaBenarViewController {
    ...
    @IBAction func lanjut8Button(_ sender: UIButton) {
        ...
        let lanjut8ViewController = UIStoryboard(name: "Katakana", bundle: nil).instantiateViewController(identifier: "KatakanaKesembilan") as! KatakanaKesembilan
...
class KatakanaBenarSembilanViewController: KatakanaBenarViewController {
    ...
    @IBAction func lanju9Button(_ sender: UIButton) {
        ...
        let lanjut9ViewController = UIStoryboard(name: "Katakana", bundle: nil).instantiateViewController(identifier: "KatakanaKesepuluh") as! KatakanaKesepuluh
...
class KatakanaBenarSepuluhViewController: KatakanaBenarViewController {
    ...
    @IBAction func lanjut10Button(_ sender: UIButton) {
        ...
        let lanjut10ViewController = UIStoryboard(name: "Katakana", bundle: nil).instantiateViewController(identifier: "KatakanaCoinViewController") as! KatakanaCoinViewController
