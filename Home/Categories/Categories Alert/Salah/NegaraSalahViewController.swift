//
//  NegaraSalahViewController.swift
//  Japanesia
//
...
class NegaraSalahViewController: UIViewController {
...
class NegaraSalahSatuViewController: NegaraSalahViewController {
    ...
    @IBAction func perbaiki1Button(_ sender: UIButton) {
        ...
        let perbaiki1ViewController = UIStoryboard(name: "Negara", bundle: nil).instantiateViewController(identifier: "NegaraPertama") as! NegaraPertama
...
class NegaraSalahDuaViewController: NegaraSalahViewController {
    ...
    @IBAction func perbaiki2Button(_ sender: UIButton) {
        ...
        let perbaiki2ViewController = UIStoryboard(name: "Negara", bundle: nil).instantiateViewController(identifier: "NegaraKedua") as! NegaraKedua
...
class NegaraSalahTigaViewController: NegaraSalahViewController {
    ...
    @IBAction func perbaiki3Button(_ sender: UIButton) {
        ...
        let perbaiki3ViewController = UIStoryboard(name: "Negara", bundle: nil).instantiateViewController(identifier: "NegaraKetiga") as! NegaraKetiga
...
class NegaraSalahEmpatViewController: NegaraSalahViewController {
    ...
    @IBAction func perbaiki4Button(_ sender: UIButton) {
        ...
        let perbaiki4ViewController = UIStoryboard(name: "Negara", bundle: nil).instantiateViewController(identifier: "NegaraKeempat") as! NegaraKeempat
...
class NegaraSalahLimaViewController: NegaraSalahViewController {
    ...
    @IBAction func perbaiki5Button(_ sender: UIButton) {
        ...
        let perbaiki5ViewController = UIStoryboard(name: "Negara", bundle: nil).instantiateViewController(identifier: "NegaraKelima") as! NegaraKelima
...
class NegaraSalahEnamViewController: NegaraSalahViewController {
    ...
    @IBAction func perbaiki6Button(_ sender: UIButton) {
        ...
        let perbaiki6ViewController = UIStoryboard(name: "Negara", bundle: nil).instantiateViewController(identifier: "NegaraKeenam") as! NegaraKeenam
...
class NegaraSalahTujuhViewController: NegaraSalahViewController {
    ...
    @IBAction func perbaiki7Button(_ sender: UIButton) {
        ...
        let perbaiki7ViewController = UIStoryboard(name: "Negara", bundle: nil).instantiateViewController(identifier: "NegaraKetujuh") as! NegaraKetujuh
...
class NegaraSalahDelapanViewController: NegaraSalahViewController {
    ...
    @IBAction func perbaiki8Button(_ sender: UIButton) {
        ...
        let perbaiki8ViewController = UIStoryboard(name: "Negara", bundle: nil).instantiateViewController(identifier: "NegaraKedelapan") as! NegaraKedelapan
...
class NegaraSalahSembilanViewController: NegaraSalahViewController {
    ...
    @IBAction func perbaiki9Button(_ sender: UIButton) {
        ...
        let perbaiki9ViewController = UIStoryboard(name: "Negara", bundle: nil).instantiateViewController(identifier: "NegaraKesembilan") as! NegaraKesembilan
...
class NegaraSalahSepuluhViewController: NegaraSalahViewController {
    ...
    @IBAction func perbaiki10Button(_ sender: UIButton) {
        ...
        let perbaiki10ViewController = UIStoryboard(name: "Negara", bundle: nil).instantiateViewController(identifier: "NegaraKesepuluh") as! NegaraKesepuluh
