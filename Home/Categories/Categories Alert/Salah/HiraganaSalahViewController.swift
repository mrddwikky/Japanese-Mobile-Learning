...
class HiraganaSalahViewController: UIViewController {
...
class HiraganaSalahSatuViewController: HiraganaSalahViewController {
    ...
    @IBAction func perbaiki1Button(_ sender: UIButton) {
        ...
        let perbaiki1ViewController = UIStoryboard(name: "Hiragana", bundle: nil).instantiateViewController(identifier: "HiraganaPertama") as! HiraganaPertama
...
class HiraganaSalahDuaViewController: HiraganaSalahViewController {
    ...
    @IBAction func perbaiki2Button(_ sender: UIButton) {
        ...
        let perbaiki2ViewController = UIStoryboard(name: "Hiragana", bundle: nil).instantiateViewController(identifier: "HiraganaKedua") as! HiraganaKedua
...
class HiraganaSalahTigaViewController: HiraganaSalahViewController {
    ...
    @IBAction func perbaiki3Button(_ sender: UIButton) {
        ...
        let perbaiki3ViewController = UIStoryboard(name: "Hiragana", bundle: nil).instantiateViewController(identifier: "HiraganaKetiga") as! HiraganaKetiga
...
class HiraganaSalahEmpatViewController: HiraganaSalahViewController {
    ...
    @IBAction func perbaiki5Button(_ sender: UIButton) {
        ...
        let perbaiki4ViewController = UIStoryboard(name: "Hiragana", bundle: nil).instantiateViewController(identifier: "HiraganaKeempat") as! HiraganaKeempat
...
class HiraganaSalahLimaViewController: HiraganaSalahViewController {
    ...
    @IBAction func perbaiki5Button(_ sender: UIButton) {
        ...
        let perbaiki5ViewController = UIStoryboard(name: "Hiragana", bundle: nil).instantiateViewController(identifier: "HiraganaKelima") as! HiraganaKelima
...
class HiraganaSalahEnamViewController: HiraganaSalahViewController {
    ...
    @IBAction func perbaiki6Button(_ sender: UIButton) {
        ...
        let perbaiki6ViewController = UIStoryboard(name: "Hiragana", bundle: nil).instantiateViewController(identifier: "HiraganaKeenam") as! HiraganaKeenam
...
class HiraganaSalahTujuhViewController: HiraganaSalahViewController {
    ...
    @IBAction func perbaiki7Button(_ sender: UIButton) {
        ...
        let perbaiki7ViewController = UIStoryboard(name: "Hiragana", bundle: nil).instantiateViewController(identifier: "HiraganaKetujuh") as! HiraganaKetujuh
...
class HiraganaSalahDelapanViewController: HiraganaSalahViewController {
    ...
    @IBAction func perbaiki8Button(_ sender: UIButton) {
        ...
        let perbaiki8ViewController = UIStoryboard(name: "Hiragana", bundle: nil).instantiateViewController(identifier: "HiraganaKedelapan") as! HiraganaKedelapan
...
class HiraganaSalahSembilanViewController: HiraganaSalahViewController {
    ...
    @IBAction func perbaiki9Button(_ sender: UIButton) {
        ...
        let perbaiki9ViewController = UIStoryboard(name: "Hiragana", bundle: nil).instantiateViewController(identifier: "HiraganaKesembilan") as! HiraganaKesembilan
...
class HiraganaSalahSepuluhViewController: HiraganaSalahViewController {
    ...
    @IBAction func perbaiki10Button(_ sender: UIButton) {
        ...
        let perbaiki10ViewController = UIStoryboard(name: "Hiragana", bundle: nil).instantiateViewController(identifier: "HiraganaKesepuluh") as! HiraganaKesepuluh
